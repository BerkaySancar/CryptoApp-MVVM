...
public protocol NewsServiceProtocol: AnyObject {
    func getCryptoNews(completion: @escaping (Result<[ArticleDTO]?, ServiceError>) -> Void) async
}
...
public final class NewsService: NewsServiceProtocol {
    ...
    public func getCryptoNews(completion: @escaping (Result<[ArticleDTO]?, ServiceError>) -> Void) async {
